...
def get_ex3_tangent_start_end_test_values() -> DubinsProblem:
    queries = []
    center1 = SE2Transform([1, 2.5], 0)
    center2 = SE2Transform([8, 2.5], 0)
    circle1 = Curve.create_circle(center=center1, radius=3, config_on_circle=SE2Transform([0., 3], 0.), curve_type=DubinsSegmentType.RIGHT)
...
def get_ex4_start_end_test_values() -> DubinsProblem:
    ...
    queries = []
    radius = 3.5
    config_list.append((SE2Transform([0., 0],0), SE2Transform([3.5, 3.5], np.pi/2))) 
